public class ApplePieRecipe
{
    ...
    {// ingredients alle defined and printed using the Ingredientclass
        //todo bonus versie: ingredienten in een arraylist zetten en in een loopje laten printen
        //todo kopje "ingredienten" afdrukken
        //define ingredients
        ...
        System.out.print(paneermeel.getAmount()+" "+paneermeel.getUnit()+" "+paneermeel.getName()+"\n");
        System.out.println("");


    }
    //todo bonus opdracht alle stapjes gezellig in 1 method zetten
